...
While some have called the set an artificial language, this scholar does not accept this diagnosis. Primarily because the language is not "spoken" by anyone, and it does not appear to develop as a language would. The conceptual characters do not have any specified pronunciation, since they are interpreted in whatever native language the reader chooses.
