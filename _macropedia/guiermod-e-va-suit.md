...
**Oxygen.** The Guiermod comes equipped with an innovative CO_2_ scrubber, using cosmic radiation to separate the elements and providing a near inexhaustible oxygen supply. That is, so long as you're within roughly 10 GIE of the radiation source. The scrubber loses efficiency beyond this range, providing many months of oxygen at 7 GIE, a few months at 4 GIE, and several weeks at GIE 1. However, beyond GIE 1, the efficiency seems constant&ndash;at least no users have complained beyond that distance. 

**Water.** The Guiermod also has an advanced H_2_0 recycle system, which recuperates the water supply for almost as long as the oxygen supply. The biggest problem with the recycle system is the amount of urea in the user builds up, which can lead to some pretty devastating problems.
